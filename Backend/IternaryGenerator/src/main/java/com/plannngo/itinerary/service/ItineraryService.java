...
import com.plannngo.itinerary.dtos.TouristItineraryRequest;
import com.plannngo.itinerary.dtos.TouristItineraryResponse;
import com.plannngo.itinerary.prompts.TouristGuidePrompt2;
...
public class ItineraryService {
    ...
    private TouristItineraryResponse generateFallbackItinerary(TouristItineraryRequest request, String errorMessage) {
        ...
        java.util.List<com.plannngo.itinerary.dtos.ItineraryDetailDto> details = new java.util.ArrayList<>();
        ...
        boolean isExploreCity = request.getExploreCity() != null 
                && !request.getExploreCity().equalsIgnoreCase("false")
                && !request.getExploreCity().isBlank();

        if (isExploreCity && request.getPlaces() != null) {
            for (String placeName : request.getPlaces()) {
                com.plannngo.itinerary.dtos.ItineraryDetailDto detail = new com.plannngo.itinerary.dtos.ItineraryDetailDto();
        ...
        if (request.getEvents() != null) {
             for (com.plannngo.itinerary.dtos.EventDto event : request.getEvents()) {
                com.plannngo.itinerary.dtos.ItineraryDetailDto detail = new com.plannngo.itinerary.dtos.ItineraryDetailDto();
