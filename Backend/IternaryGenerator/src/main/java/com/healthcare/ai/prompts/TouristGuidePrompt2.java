package com.healthcare.ai.prompts;
...
public final class TouristGuidePrompt2 {
    ...
    public static final String USER_PROMPT = """
    		...
    		3. location_url  ← YOU MUST GENERATE A REAL GOOGLE MAPS URL
    		4. start_time    ← YOU MUST GENERATE A REALISTIC START TIME (ISO 8601)
    		5. end_time      ← YOU MUST GENERATE A REALISTIC END TIME (ISO 8601)
    		6. notes

    		YOU ARE RESPONSIBLE FOR ENRICHMENT.
    		The input places list contains ONLY NAMES — you must convert them into FULL itinerary objects.
